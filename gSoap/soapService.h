...
#include "soapH.h"
    ...
    class SOAP_CMAC Service {
      public:
        ...
        virtual int Probe(struct wsd__ProbeType *wsd__Probe) SOAP_PURE_VIRTUAL;
        ...
        virtual int ProbeMatches(struct wsd__ProbeMatchesType *wsd__ProbeMatches) SOAP_PURE_VIRTUAL;
