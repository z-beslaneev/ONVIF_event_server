...
#include "soapH.h"
    ...
    class SOAP_CMAC NotificationProducerBindingService {
      public:
        ...
        bool soap_own;
        /// Variables globally declared in WS/onvifFull.h, if any
        /// Construct a service with new managing context
        NotificationProducerBindingService();
        /// Copy constructor
        NotificationProducerBindingService(const NotificationProducerBindingService&);
        ...
        virtual NotificationProducerBindingService *copy() SOAP_PURE_VIRTUAL_COPY;
        /// Copy assignment
        NotificationProducerBindingService& operator=(const NotificationProducerBindingService&);
